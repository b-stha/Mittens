...
const std::unordered_map<std::string, TraitTemplate> traitData = {
	{"tft15_destroyer", TraitTemplate("Executioner",
			  {2, 3, 4, 5},
			  {{1, ""}, {2, ""}, {4, ""}})},
	{"tft15_dragonfist", TraitTemplate("Stance Master",
			  {1},
			  {{3, ""}})},

	{"tft15_edgelord", TraitTemplate("Edgelord",
			  {2, 4, 6},
			  {{3, ""}, {3, ""}, {3, ""}})},

	{"tft15_gemforce", TraitTemplate("Crystal Gambit",
			  {3, 5, 7, 10},
			  {{1, ""}, {3, ""}, {3, ""}, {3, ""}})},

	{"tft15_sniper", TraitTemplate("Sniper",
			  {2, 4, 6},
			  {{1, ""}, {3, ""}, {3, ""}})},
	...
	{"tft15_supremecells", TraitTemplate("Supreme Cells",
			  {2, 3, 4},
			  {{1, ""}, {3, ""}, {3, ""}})},
	...
	{"tft15_captain", TraitTemplate("Rogue Captain",
			  {1},
			  {{1, ""}})},
